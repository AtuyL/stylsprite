var dirname = require('path').dirname,
    ...
    execDefine = function (url, pixelRatio) {
        ...
        canvas_width = 0;
        canvas_height = 0;
        Object.keys(data.sprites).forEach(function (src) {
...
module.exports = function (cssFile, root) {
    var cssDir = dirname(cssFile);
    cssDir = relative(root, cssDir) || '.';

    return function (url, pixelRatio) {
        url = new URL(url, cssDir, root || '.');
