...
module.exports = function (options) {
    ...
    return function (req, res, next) {
        ...
        if (!/\.css$/i.test(path)) return next();
        ...
        paths = {
            srcPath: typeof src === "function" ? src(path) : join(src, path.replace('.css', '.styl')),
            destPath: typeof dest === "function" ? dest(path) : join(dest, path),
