...
module.exports = function (paths, options) {
    ...
    return function (req, res, next) {
        ...
        var stylPath = typeof src === "function" ? src(path) : join(src, path.replace('.css', '.styl'));
        ...
        var srcCode = fs.readFileSync(stylPath).toString();

        return compileStylusAsync(srcCode, resolved, options, function (updated) {
            if (updated) {
                try {
